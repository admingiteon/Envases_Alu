...
view: Fact_Alu_Pet {
  derived_table: {
    sql: SELECT * ,DATE_ADD(CURRENT_DATE(), INTERVAL -1 DAY) ACTUALIZACION FROM `envases-analytics-qa.DATASET_RAW.mck_columnar_consolidado` ;;
  }
